...
<div className="max-w-5xl mx-auto px-6 mb-16">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="bg-white dark:bg-transparent rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="space-y-2">
        <a href="/guides/financial-planning/overview/introduction" className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
          <span className="text-gray-700 dark:text-gray-300">
            Introduction
          </span>
        ...
        <a href="/guides/financial-planning/overview/getting-started" className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
          <span className="text-gray-700 dark:text-gray-300">
            Getting Started
          </span>
        ...
        <a href="/guides/financial-planning/best-practices" className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
          <span className="text-gray-700 dark:text-gray-300">
            Best Practices
          </span>
        ...
        <a href="/guides/financial-planning/troubleshooting-and-faq" className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
          <span className="text-gray-700 dark:text-gray-300">
            Troubleshooting & FAQ
          </span>
